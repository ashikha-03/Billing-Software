...
static constexpr auto qt_meta_stringdata_CLASSProductsENDCLASS = QtMocHelpers::stringData(
    "Products",
    "on_pBSave_clicked",
    "",
    "on_pBCancel_clicked",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSProductsENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSProductsENDCLASS_t qt_meta_stringdata_CLASSProductsENDCLASS = {
    {
        QT_MOC_LITERAL(0, 8),  // "Products"
